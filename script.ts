...
const NAME_ROW_INDEX = columnToIndex(NAME_ROW_COLUMN);
const EMAIL_ROW_INDEX = columnToIndex(EMAIL_ROW_COLUMN);
const SOCIALS_ROW_INDEX = columnToIndex(SOCIALS_ROW_COLUMN);
